...
columns:
    ...
    flow_target_error - difference (in % from desired flow) between actual flow through the Bronkhorst EL-FLOW mass flow controller for target gas and desired flow
    flow_carrier_error - same, but for carrier gas
    meas_cycle - # of the measurement cycle (0-9)
...
# Excerpts from the article explaining the data acquisition process
...
![Fig_S1](Data acquisition setup - Fig S1.png)
...
![Fig_1](Measurements protocol Fig 1.png)
