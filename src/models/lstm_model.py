...
from tf.keras.layers import LSTM, Dense, Dropout  # pyright: ignore[reportMissingImports]
from tf.keras.optimizers import Adam  # pyright: ignore[reportMissingImports]
...
def train_lstm(
    ...
    val_rmse = mean_squared_error(y_val, y_pred, squared=False, multioutput='uniform_average')
...
def evaluate_lstm(
    ...
    # Overall RMSE
    rmse_overall = mean_squared_error(y_test, y_pred, squared=False, multioutput='uniform_average')
